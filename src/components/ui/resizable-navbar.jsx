...
export const NavItems = ({ items, className, onItemClick }) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "hidden flex-1 flex-row items-center justify-center space-x-1 text-sm font-medium text-white transition duration-200 hover:text-orange-400 lg:flex lg:space-x-1",
        className,
      )}
    >
      {items.map((item, idx) => (
        <a
          ...
          onClick={onItemClick}
          className="relative whitespace-nowrap px-3 py-2 text-white dark:text-neutral-200"
          key={`link-${idx}`}
          href={item.link}
        >
          {hovered === idx && (
...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return isOpen ? (
    ...
    >
      <X className="text-white hover:text-orange-400 transition-colors" />
    </button>
  ) : (
    <button
      onClick={onClick}
    ...
    >
      <Menu className="text-white hover:text-orange-400 transition-colors" />
    </button>
  );
};
...
export const NavbarLogo = () => {
  return (
    ...
    >
      ...
      <span className="whitespace-nowrap font-medium text-white dark:text-white">
        cult.fit
      </span>
    </a>
  );
...
export const NavbarButton = ({
  ...
  const baseStyles =
    "px-4 py-2 rounded-md bg-orange-500 button text-white text-sm font-bold relative cursor-pointer hover:-translate-y-0.5 hover:bg-orange-600 transition duration-200 inline-block text-center";

  const variantStyles = {
    primary:
      "shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    secondary: "bg-transparent shadow-none text-white hover:text-orange-400",
  };
